...
export const metadata: Metadata = {
  title: "Coquí Focus - Pomodoro Timer",
  description: "Un temporizador Pomodoro con sabor puertorriqueño",
...
export const viewport: Viewport = {
  themeColor: [
    { media: "(prefers-color-scheme: light)", color: "#EF3340" },

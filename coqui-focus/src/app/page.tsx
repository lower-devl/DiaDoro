  ...
  return (
    <div className="min-h-screen transition-colors duration-300">
      ...
      <main className="flex flex-col items-center justify-center px-4 py-8 sm:py-12 md:py-16 lg:py-20 relative z-10">
        {/* Glassmorphism Card */}
        <div className="bg-white/80 dark:bg-[#0a1929]/80 backdrop-blur-md rounded-3xl shadow-2xl p-8 sm:p-12 border border-white/20 dark:border-white/10">
        ...
        {/* Instructions */}
        <div className="mt-8 sm:mt-12 text-center max-w-md px-4">
          <p className="text-white/90 dark:text-white/80 text-sm sm:text-base drop-shadow-lg">
